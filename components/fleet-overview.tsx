  ...
  const getMELItems = (ac: Aircraft) => {
    ...
    return ac.defects
      ...
      .map((defect) => {
        ...
        const dueDateStr = `${dueDate.getFullYear()}-${String(dueDate.getMonth() + 1).padStart(2, "0")}-${String(dueDate.getDate()).padStart(2, "0")} 00:00:  + 1).padStart(2, "0")}-${String(dueDate.getDate()).padStart(2, "0")} 00:00:00`
                          ...
                          <Tabs defaultValue="details" value={activeTab} onValueChange={setActiveTab}>
                            ...
                            <TabsContent value="create-event" className="mt-0">
                                  ...
                                  <div>
                                    ...
                                    <Select value={updateType} onValueChange={setUpdateType}>
                                      ...
                                      <SelectContent>
                                        ...
                                        <SelectItem value="MOV (Aircraft Movement)">MOV (Aircraft Movement)</SelectItem>
                              ...
                              <div className="mt-6 space-y-6">
                                ...
                                {/* Sample event entries based on the screenshots */}
                                <div className="space-y-4">
                                  {ac.id === "AC129" && (
                                    <>
                                      <div className="bg-gray-800 p-4 rounded-md">
                                        <div className="flex justify-between items-center mb-2">
                                          <h4 className="font-medium">TRS (Troubleshooting)</h4>
                                          <span className="text-sm text-gray-400">11:45:00</span>
                                        </div>
                                        <p className="text-sm">
                                          HYD LEAK FOUND TO BE OUT OF LIMITS, PCU CHANGE REQUIRED. (MACHT / 1145-MOC)
                                        </p>
                                      </div>
                                      ...
                                      <div className="bg-gray-800 p-4 rounded-md">
                                        <div className="flex justify-between items-center mb-2">
                                          <h4 className="font-medium">TRS (Troubleshooting)</h4>
                                          <span className="text-sm text-gray-400">09:50:00</span>
                                        </div>
                                        <p className="text-sm">
                                          HYD LEAK FOUND FROM F / CTL ACTUATOR, RH AILERON PCU. INV ESTGATION IN
                                          PROGRESS. (MACHT / 0950-MOC)
                                        </p>
                                      </div>

                                      <div className="bg-gray-800 p-4 rounded-md">
                                        <div className="flex justify-between items-center mb-2">
                                          <h4 className="font-medium">Start of Maintenance</h4>
                                          <span className="text-sm text-gray-400">09:50:00</span>
                                        </div>
                                        <p className="text-sm">Start X</p>
                                      </div>
                                    </>
                                  )}
                                </div>
